package mod.colbaskerville.tutorialmod.world.gen;
...
public class WorldGenCustomOres implements IWorldGenerator
{
	...
	{
		ore_nether_ruby = new WorldGenMinable(ModBlocks.ORE_NETHER.getDefaultState().withProperty(BlockOres.VARIANT, EnumHandler.EnumType.RUBY), 9, BlockMatcher.forBlock(Blocks.NETHERRACK));
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,IChunkProvider chunkProvider) 
	{
		...
		case -1:
			...
			runGenerator(ore_nether_ruby, world, random, chunkX, chunkZ, 100, 0, 100);
		
		break;
		
		case 0:
			
			runGenerator(ore_overworld_ruby, world, random, chunkX, chunkZ, 100, 0, 100);
		
		break;
		
		case 1:
			
			runGenerator(ore_end_ruby, world, random, chunkX, chunkZ, 100, 0, 100);
