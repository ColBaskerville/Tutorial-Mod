package mod.colbaskerville.tutorialmod.blocks.machines.sinterer;
...
public class SinteringFurnaceRecipes 
{
	...
	{
		addSinteringRecipe(new ItemStack(ModBlocks.ORE_OVERWORLD), new ItemStack(ModItems.RUBY), new ItemStack(ModItems.RUBY_BOOTS), 5.0F);
		addSinteringRecipe(new ItemStack(ModBlocks.ORE_NETHER), new ItemStack(Blocks.NETHER_WART_BLOCK), new ItemStack(ModItems.RUBY), 5.0F);
		addSinteringRecipe(new ItemStack(ModBlocks.ORE_END), new ItemStack(Blocks.RED_SHULKER_BOX), new ItemStack(ModItems.RUBY), 5.0F);
	}
