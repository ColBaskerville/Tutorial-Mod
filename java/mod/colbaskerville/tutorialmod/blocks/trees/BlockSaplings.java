...
public class BlockSaplings extends BlockBush implements IGrowable, IMetaName, IHasModel
{
    ...
    public BlockSaplings(String name) 
    {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, BlockPlank.EnumType.APPLE).withProperty(STAGE, Integer.valueOf(0)));
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(ModBlocks.SAPLING), i, "sapling_" + BlockPlank.EnumType.values()[i].getName(), "inventory");
		}
	}
