...
public class BlockLogs extends BlockLog implements IHasModel, IMetaName 
{
	...
	public BlockLogs(String name) 
	{
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, BlockPlank.EnumType.APPLE).withProperty(LOG_AXIS, EnumAxis.Y));
	...
	public void registerModels() 
	{
		...
		{
			Main.proxy.registerVariantRenderer(Item.getItemFromBlock(ModBlocks.LOG), i, "log_" + BlockPlank.EnumType.values()[i].getName(), "inventory");
		}
	}
}
